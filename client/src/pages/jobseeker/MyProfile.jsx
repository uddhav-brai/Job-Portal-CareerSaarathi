...
import { FaFilePdf, FaLinkedin, FaTimes, FaUpload } from "react-icons/fa";
...
const MyProfile = () => {
  ...
  // Function to format date to show month and year
                ...
                <div className="mt-3 w-full">
                          ...
                          <div className="relative bg-white rounded-lg shadow-xl max-w-screen-lg w-full h-full overflow-hidden">
                            ...
                            <div className="p-6 h-full overflow-auto">
                              {pdfBlob && (
                                ...
                                >
                                  <p>
                                    PDF viewer is not available. You can
                  ...
                  <div className="mb-4">
                    <button
                      ...
                      className="bg-blue-500 text-white py-2 px-9 rounded hover:bg-blue-600 flex items-center w-full"
                    >
                      <FaUpload className="text-white mr-2" size={20} />
                      Upload Resume
                    </button>
                    {showModal && <UploadResume onClose={toggleModal} />}
                  </div>
                </div>
